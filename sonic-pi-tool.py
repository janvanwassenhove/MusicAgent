...
class Installation:
    ...
    default_paths = ('./Sonic Pi.app/Contents/Resources/app',  # Check current dir first
                     ...
                     '/usr/bin/sonic-pi',
                     '/usr/lib/sonic-pi',
                     r'C:\Program Files\Sonic Pi\app\gui\qt\build\Release')
    ...
    server_paths = ['server/ruby/bin/sonic-pi-server.rb',
                    ...
                    r'C:\Program Files\Sonic Pi\app\server\ruby\bin\spider-server.rb']
    ...
    def __init__(self, base, logger):
        ...
        for i, path in enumerate(Installation.ruby_paths):
            ...
            #print("Checking expanded path: ", expanded_path)
            if os.path.isfile(self.expand_path(path)):
                print("Found Ruby at: ", expanded_path)
                self.ruby = i
                break
        self.server = None
        #print(self.server)
